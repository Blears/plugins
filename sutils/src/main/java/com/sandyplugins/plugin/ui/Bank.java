package com.sandyplugins.plugin.ui;

import lombok.extern.slf4j.Slf4j;
import net.runelite.api.InventoryID;
import net.runelite.api.ItemComposition;
import com.sandyplugins.plugin.game.Game;
import com.sandyplugins.plugin.game.InventoryItem;
import com.sandyplugins.plugin.game.ItemQuantity;
import com.sandyplugins.plugin.game.iWidget;
import com.sandyplugins.plugin.sUtils;
...
public class Bank {
    ...
    public int withdraw(int id, int quantity, boolean noted) {
        ...
        for (iWidget item : sUtils.bankitems) {
            if (item.itemId() == id) {
    ...
    public boolean deposit(int id, int quantity) {
        ...
        for (iWidget item : sUtils.bankInventoryitems) {
            if (item.itemId() == id) {
...
//    }
    ...
    public List<iWidget> items() {
        if (sUtils.bankitems.isEmpty()) {
            game.tick(); //Give time for items to load
        }
        return sUtils.bankitems;
    }
