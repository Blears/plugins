...
import com.sandyplugins.plugin.actor.NpcStream;
import com.sandyplugins.plugin.actor.PlayerStream;
import com.sandyplugins.plugin.api.EquipmentSlot;
import com.sandyplugins.plugin.scene.GameObjectStream;
import com.sandyplugins.plugin.scene.GroundItemStream;
import com.sandyplugins.plugin.scene.ObjectCategory;
import com.sandyplugins.plugin.scene.Position;
import com.sandyplugins.plugin.ui.EquipmentItemStream;
import com.sandyplugins.plugin.ui.InventoryItemStream;
...
public class Game {
    ...
    public GameObjectStream objects() {
        return getFromClientThread(() -> new GameObjectStream(sUtils.objects.stream()
                .map(o -> new iObject(
                        this,
                        o,
    ...
    public GroundItemStream groundItems() {
        return getFromClientThread(() -> new GroundItemStream(sUtils.tileItems.stream()
