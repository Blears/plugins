...
import com.sandyplugins.plugin.game.iObject;
import com.sandyplugins.plugin.game.iWidget;
...
@PluginDescriptor(
        name = "sUtils",
        description = "Sandy plugin utilities"
)
@Slf4j
@SuppressWarnings("unused")
@Singleton
public class sUtils extends Plugin {
...
/*    @Provides
    ...
    @Provides
    sUtilsConfig provideConfig(ConfigManager configManager) {
        return configManager.getConfig(sUtilsConfig.class);
    }
    ...
    private void onConfigButtonPressed(ConfigButtonClicked configButtonClicked) {
        if (!configButtonClicked.getGroup().equalsIgnoreCase("sUtils")) {
            return;
        }
    ...
    public void doInvokeClientTick(LegacyMenuEntry entry, long ticksToDelay) {
    ...
    public void doGameObjectActionClientTick(GameObject object, MenuAction type, long ticksToDelay) {
        ...
        LegacyMenuEntry entry = new LegacyMenuEntry("", "", object.getId(), type, object.getSceneMinLocation().getX(),
    ...
    public void doTileObjectActionClientTick(TileObject object, MenuAction type, long ticksToDelay) {
        if (object == null) {
            return;
        }
        Rectangle rectangle = (object.getCanvasTilePoly().getBounds() != null) ? object.getCanvasTilePoly().getBounds() :
                new Rectangle(client.getCenterX() - 50, client.getCenterY() - 50, 100, 100);
        LegacyMenuEntry entry = new LegacyMenuEntry("", "", object.getId(), type, object.getLocalLocation().getSceneX(),
                object.getLocalLocation().getSceneY(), false);
        doActionClientTick(entry, rectangle, ticksToDelay);
    }

    public void doNpcActionClientTick(NPC npc, MenuAction type, long ticksToDelay) {
        if (npc == null || npc.getConvexHull() == null) {
            return;
        }
        Rectangle rectangle = (npc.getConvexHull().getBounds() != null) ? npc.getConvexHull().getBounds() :
                new Rectangle(client.getCenterX() - 50, client.getCenterY() - 50, 100, 100);
        LegacyMenuEntry entry = new LegacyMenuEntry("", "", npc.getIndex(), type, 0, 0, false);
        doActionClientTick(entry, rectangle, ticksToDelay);
    }

    public void doItemActionClientTick(WidgetItem item, MenuAction type, int menuParam1ID, long ticksToDelay) {
        if (item == null) {
            return;
        }
        LegacyMenuEntry entry = new LegacyMenuEntry("", "", item.getId(), type,
                item.getIndex(), menuParam1ID, true);
        doActionClientTick(entry, item.getCanvasBounds().getBounds(), ticksToDelay);
    }

    //Use with caution, does not pair with mouse click and is potentially detectable
    public void doInvokeGameTick(LegacyMenuEntry entry, long ticksToDelay) {
        Runnable runnable = () -> client.invokeMenuAction(entry.getOption(), entry.getTarget(), entry.getIdentifier(),
                entry.getOpcode(), entry.getParam0(), entry.getParam1());
        action.delayGameTicks(ticksToDelay, runnable);
    }
    ...
    public void doGameObjectActionGameTick(GameObject object, MenuAction type, long ticksToDelay) {
        if (object == null || object.getConvexHull() == null) {
            return;
        }
        Rectangle rectangle = (object.getConvexHull().getBounds() != null) ? object.getConvexHull().getBounds() :
    ...
    public void doTileObjectActionGameTick(TileObject object, MenuAction type, long ticksToDelay) {
        if (object == null) {
            return;
        }
        Rectangle rectangle = (object.getCanvasTilePoly().getBounds() != null) ? object.getCanvasTilePoly().getBounds() :
    ...
    public void doNpcActionGameTick(NPC npc, MenuAction type, long ticksToDelay) {
        if (npc == null || npc.getConvexHull() == null) {
            return;
        }
        Rectangle rectangle = (npc.getConvexHull().getBounds() != null) ? npc.getConvexHull().getBounds() :
    ...
    public void doItemActionGameTick(WidgetItem item, MenuAction type, int menuParam1ID, long ticksToDelay) {
        if (item == null) {
            return;
        }
        LegacyMenuEntry entry = new LegacyMenuEntry("", "", item.getId(), type,
    ...
    public void doGameObjectActionMsTime(GameObject object, MenuAction type, long timeToDelay) {
        if (object == null || object.getConvexHull() == null) {
            return;
        }
        Rectangle rectangle = (object.getConvexHull().getBounds() != null) ? object.getConvexHull().getBounds() :
    ...
    public void doTileObjectActionMsTime(TileObject object, MenuAction type, long timeToDelay) {
        if (object == null) {
            return;
        }
        Rectangle rectangle = (object.getCanvasTilePoly().getBounds() != null) ? object.getCanvasTilePoly().getBounds() :
    ...
    public void doNpcActionMsTime(NPC npc, MenuAction type, long timeToDelay) {
        if (npc == null || npc.getConvexHull() == null) {
            return;
        }
        Rectangle rectangle = (npc.getConvexHull().getBounds() != null) ? npc.getConvexHull().getBounds() :
    ...
    public void doItemActionMsTime(WidgetItem item, MenuAction type, int menuParam1ID, long timeToDelay) {
        if (item == null) {
            return;
        }
        LegacyMenuEntry entry = new LegacyMenuEntry("", "", item.getId(), type,
...
/*    @Subscribe
    private void onLegacyMenuEntryAdded(LegacyMenuEntryAdded event) {
        ...
        if (menu.entry != null) {
            client.setLeftClickLegacyMenuEntry(menu.entryAdded);
