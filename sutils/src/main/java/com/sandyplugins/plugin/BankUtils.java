...
import static com.sandyplugins.plugin.sUtils.iterating;
import static com.sandyplugins.plugin.sUtils.sleep;
...
public class BankUtils {
    ...
    public void close() {
        ...
        menu.setEntry(new LegacyMenuEntry("", "", 1, MenuAction.CC_OP, 11, 786434, false)); //close bank
    ...
    public void depositAll() {
        ...
        executorService.submit(() ->
        {
            ...
            if (isDepositBoxOpen()) {
                menu.setEntry(new LegacyMenuEntry("", "", 1, MenuAction.CC_OP, -1, 12582916, false)); //deposit all in bank interface
            } else {
                menu.setEntry(new LegacyMenuEntry("", "", 1, MenuAction.CC_OP, -1, 786474, false)); //deposit all in bank interface
            }
    ...
    public void depositAllOfItem(WidgetItem item) {
        ...
        menu.setEntry(new LegacyMenuEntry("", "", (depositBox) ? 1 : 8, MenuAction.CC_OP, item.getIndex(),
    ...
    public void depositOneOfItem(WidgetItem item) {
        ...
        menu.setEntry(new LegacyMenuEntry("", "", (client.getVarbitValue(6590) == 0) ? 2 : 3, MenuAction.CC_OP, item.getIndex(),
                (depositBox) ? 12582914 : 983043, false));
    ...
    public void withdrawAllItem(Widget bankItemWidget) {
        executorService.submit(() ->
        {
            menu.setEntry(new LegacyMenuEntry("Withdraw-All", "", 7, MenuAction.CC_OP, bankItemWidget.getIndex(), WidgetInfo.BANK_ITEM_CONTAINER.getId(), false));
            mouse.clickRandomPointCenter(-200, 200);
        });
    }
    ...
    public void withdrawItem(Widget bankItemWidget) {
        LegacyMenuEntry entry = new LegacyMenuEntry("", "", (client.getVarbitValue(6590) == 0) ? 1 : 2, MenuAction.CC_OP,
        ...
        clientThread.invokeLater(() -> {
            ...
            if (item != null) {
                ...
                utils.doActionMsTime(
                        new LegacyMenuEntry("", "", identifier, MenuAction.CC_OP, item.getIndex(), WidgetInfo.BANK_ITEM_CONTAINER.getId(), false),
